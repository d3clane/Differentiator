...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Graphs/graph_1337_time_23:25:19.png}
\end{figure}
График разложение по маклорену:

\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Graphs/graph_1338_time_23:25:19.png}
\end{figure}
Сравнение графиков функции и маклорена в окрестности нуля:

\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Graphs/graph_1339_time_23:25:19.png}
\end{figure}
График разницы между функцией и разложение по маклорену:

\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Graphs/graph_1340_time_23:25:19.png}
\end{figure}
